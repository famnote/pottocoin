...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Pottocoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"pottocointools.com", "dnsseed.pottocointools.com"},
    {"pottocoinpool.org", "dnsseed.pottocoinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"pottocointools.com", "testnet-seed.pottocointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Pottocoin is probably already running."), addrBind.ToString().c_str());
        else
